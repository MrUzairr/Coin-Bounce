...
const blogController = {
    async create(req,res,next){
        ...
        // photo from client side --> base64 encoded string --> decode in backend --> store --> svae photo's path in db
    ...
    async update(req,res,next){
        ...
        if(photo){
            ...
            await Blog.updateOne(
                {_id: blogId}, {title, content, photoPath: `${BACKEND_SERVER_PATH}/storage/${imagePath}`}
            );
        }
        else{
